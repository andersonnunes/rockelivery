defmodule Rockelivery.Orders.Create do
  ...
  defp fetch_items(%{"items" => items_params}) do
    ...
    query
    |> Repo.all()
    |> validate_and_multiply_items(items_ids)
  end

  defp validate_and_multiply_items(items, items_ids) do
    ...
    |> multiply_items(items_map, items_map)
  end

  defp multiply_items(true, _items, _item_params), do: {:error, "Invalid ids!"}
